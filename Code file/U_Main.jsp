      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
				  ...
				  <p><a href="U_View_All_Dataset_Details.jsp">View All Uploaded Datasets</a></p>
				  <p><a href="U_Find_Post_Type_Status.jsp">Find Post Type Status</a></p>
				  
				  
				  <p><a href="U_Find_Post_Type_Results_By_Hashcode.jsp">Find Post Type Results By Hashcode</a></p>
