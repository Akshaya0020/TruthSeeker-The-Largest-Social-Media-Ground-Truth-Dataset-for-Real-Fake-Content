...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span class="style12">Truthseeker The largest social media Ground Truth Dataset for Real or Fake content </span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
        ...
        <div class="article">
          ...
          <div class="post_content">
            <p align="justify">&nbsp;</p>
       	    ...
       	    <h2 align="center"><span class="style7">Post Type  Status   !!! </span><br />
       	      <br />
       	    </h2>
	...
	<table width="310" height="92" border="3" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#99FF33">
					<td  width="302" height="36" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6 style11">Post Type Detail </div></td>
