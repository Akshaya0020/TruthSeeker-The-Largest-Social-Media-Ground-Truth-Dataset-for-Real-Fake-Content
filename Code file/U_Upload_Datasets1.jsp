...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style6"><a href="#">Truthseeker The largest social media Ground Truth Dataset for Real or Fake content </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
		  <li><a href="#"></a></li>
...
<%@page
    ...
    try{
	   ...
	   String Pid,title,post,posttype,hc;
       ...
       for(int i=1; i<=sheet.getLastRowNum(); i++){  //points to the starting of excel i.e excel first row
           row = (Row) sheet.getRow(i);  //sheet number
				 ...
				 if( row.getCell(0)==null) { Pid = "0";}  //suppose excel cell is empty then its set to 0 the variable
				  ...
				  if( row.getCell(2)==null) { post = "0";}
				  else post = row.getCell(2).toString();
				  
				   if( row.getCell(3)==null) { posttype = "0";}  
                  else posttype = row.getCell(3).toString();   
				  
				  
				 			  
				    String filename="filename.txt";
      				PrintStream p = new PrintStream(new FileOutputStream(filename));
					p.print(new String(posttype));
		...
		stss.executeUpdate("insert into datasets(Pid,title,post,posttype,hc)values('"+Pid+"','"+title+"','"+post+"','"+posttype+"','"+h1+"')"); 
